            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Ouverture <?php echo $row->name; ?> iBanque</h1>
                            </div>
                </section>
                                ...
                                <div class="card card-purple">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-6 form-group" style="display:none">
                                                    <label for="exampleInputEmail1">Fond</label>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="open_account" class="btn btn-success">Ouvrir votre compte</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
